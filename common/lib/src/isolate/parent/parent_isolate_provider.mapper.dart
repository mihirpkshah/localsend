...
class ParentIsolateStateMapper extends ClassMapperBase<ParentIsolateState> {
  ...
  static IsolateConnector<
    IsolateTaskResult<Device>,
    SendToIsolateData<IsolateTask<HttpTargetTask>>
  >?
  _$httpTargetDiscovery(ParentIsolateState v) => v.httpTargetDiscovery;
  static const Field<
    ParentIsolateState,
    IsolateConnector<
      IsolateTaskResult<Device>,
...
class _ParentIsolateStateCopyWithImpl<$R, $Out>
  ...
  ParentIsolateState $make(CopyWithData data) => ParentIsolateState(
    ...
    httpTargetDiscovery: data.get(
      #httpTargetDiscovery,
      or: $value.httpTargetDiscovery,
    ),
